...
% ════════════════════════
\node[font=\small\bfseries, anchor=east] at (0.9,-1.9) {\textbf{Базовая}};
...
% ════════════════════════
\node[font=\small\bfseries, anchor=east] at (0.9,-3.75) {\textbf{Обобщенная}};
...
% ════════════════════════
\node[font=\small\bfseries, anchor=east] at (0.9,-6.1) {\textbf{Предлагаемая}};
