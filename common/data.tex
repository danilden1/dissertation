%%% Основные сведения %%%
\newcommand{\thesisAuthorLastName}{Сидоренко}
\newcommand{\thesisAuthorOtherNames}{Данил Дмитриевич}
...
{Физически информированная нейросетевая система восстановления 
траектории мобильного робота при кратковременных потерях сигнала
